...
class TempDataset(InMemoryDataset):
    ...
    def __init__(self, root='/home/jbd3qn/Downloads/critical_temp_GCNN/chemprop_splits_csv',raw_name ,processed_name ,transform=None, pre_transform=None, log=True):
